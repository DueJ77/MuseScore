...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
	...
	/// Cipher style definitions
    styleDef(cipherHeightDisplacement,     0.45),
    styleDef(cipherDistanceOctave,         0.5),
    styleDef(cipherHeigthLine,             0.14),
    styleDef(cipherOffsetLine,             0.0),
    styleDef(cipherDistanceBetweenLines,   0.21),
    styleDef(cipherWideLine,               0.7),
    styleDef(cipherThickLine,              0.07),
    styleDef(cipherSizeSignSharp,          1.07),
    styleDef(cipherSizeSignFlat,           1.0),
    styleDef(cipherDistanceSignSharp,      0.7),
    styleDef(cipherDistanceSignFlat,       0.42),
    styleDef(cipherHeigthSignSharp,        0.28),
    styleDef(cipherHeigthSignFlat,         0.46),
    styleDef(cipherFont,                   "Cipher"),
    styleDef(cipherbracket,                false),
    styleDef(cipherAlternativSize,         0.7),
    styleDef(cipherAlternativSpace,        0.0),
    styleDef(cipherSlurEckenform,          0.0),
    styleDef(cipherSlurThick,              1.3),
    styleDef(cipherSlurHeigth,             0.2),
    styleDef(cipherSlurUberhang,           -0.08),
    styleDef(cipherSlurShift,              0.0),
    styleDef(cipherLedgerlineThick,        0.06),
    styleDef(cipherLedgerlineLength,       1.2),
    styleDef(cipherLedgerlineShift,        0.0),
    styleDef(cipherStaffDistans,           Spatium(3.5)),
    styleDef(cipherTimeSigSize,            0.95),
    styleDef(cipherTimeSigDistance,        0.15),
    styleDef(cipherTimeSigLineThick,       0.09),
    styleDef(cipherTimeSigLineSize,        1.0),
    styleDef(cipherTimeSigFont,            "Cipher"),
    styleDef(cipherKeySigFont,             "Cipher"),
    styleDef(cipherKeySigSize,             0.95),
    styleDef(cipherKeySigHorizontalShift,  1.0),
    styleDef(cipherKeySigHigth,            2.5),
    styleDef(cipherKeysigNoteDistancLeft,  0.5),
    styleDef(cipherKeysigNoteDistancReigth,1.0),
    styleDef(cipherBarlineLength,          1.0),
    styleDef(cipherFontSize,               12.0),
    styleDef(cipherRestDistanc,            1.0),
    styleDef(cipherNoteDistanc,            1.0),
    styleDef(cipherAccidentalFont,         "Cipher"),
    styleDef(cipherTupletSlurEcke,         0.1),
    styleDef(cipherTupletSlurhigth,        0.8),
    styleDef(cipherTupletSlurdistans,      0.0),
    styleDef(cipherTupletSlurshift,        0.0),
    styleDef(cipherTupletSluruberhang,     0.0),
    styleDef(cipherTupletNummerHigth,      0.0),
